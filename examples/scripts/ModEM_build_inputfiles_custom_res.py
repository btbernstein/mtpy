...
mo = Model(station_locations=do.station_locations,
           ...
           res_initial_value=100,  # halfspace resistivity value for reference model
           ...
           res_initial_method='by_range',  # provide custom initial resistivity values
           res_initial_custom_depth_ranges=[(0, 1000), (5000, 10000)],  # depth ranges to assign res values to
           # Assign initial res 200 to depths 0 to 1000 and 300 to depths 5000, 10000
